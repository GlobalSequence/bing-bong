...
//     65535, 18904, 16417, 14306, 12507, 10968, 9647, 8509, 7525, 6672, 5931, 5285, 4719, 4224, 3788, 3405, 3066, 2766, 2500, 2264, 2053, 1865, 1697, 1546, 1411, 1290, 1180, 1082, 993, 912, 839, 773, 713, 658, 608, 562, 521, 483, 448, 416, 387, 360, 335, 313, 292, 272, 255, 238, 223, 209, 196, 184, 172, 162, 152, 143, 135, 127, 119, 113, 106, 100, 95, 90, 85, 80, 76, 72, 68, 64, 61, 58, 55, 52, 50, 47, 45, 43, 41, 39, 37, 35, 33, 32, 30, 29, 28, 26, 25, 24, 23, 22, 21, 20, 19, 18, 18, 17, 16, 16, 15, 14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 9, 8, 7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1
// };
...
inline void EnvUpdate(
    ...
    struct Env_Params* e)
{
    e->stage_phase_increment_[ATTACK] = res_env_portamento_increments[attack];
    e->stage_phase_increment_[DECAY] = res_env_portamento_increments[decay];
    e->stage_phase_increment_[RELEASE] = res_env_portamento_increments[release];
    e->stage_target_[DECAY] = sustain << 1;
...
// C++ Version, missing some adaptations above
/* 
class Envelope
{
public:
